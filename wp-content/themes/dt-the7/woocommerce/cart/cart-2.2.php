	...
	<tbody>
		...
		<tr>
			<td colspan="6" class="actions">
				...
				<input type="submit" class="button" name="update_cart" value="<?php _e( 'Update Cart', LANGUAGE_ZONE ); ?>" /> <input type="submit" class="checkout-button button alt wc-forward" name="proceed" value="<?php _e( 'Proceed to Checkout', LANGUAGE_ZONE ); ?>" />
